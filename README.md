...
````
First create an api key from the https://developers.google.com 
and then add this key in https://github.com/Nariman-Haidar/projectWeb/blob/main/src/js/apiConfig.js.
